"""tianluo.i18n — internationalization of CLI / console UI text.
...
isolation and the core/server import boundary. It also keeps ``import tianluo.i18n``
...
def resolve_language(project_root: Optional[Path]) -> str:
    ...
    try:
        from tianluo.config import LanguageConfig
...
def reset_language() -> None:
    ...
    (pairs with :func:`tianluo.i18n.loader.clear_caches` for catalog mutations).
    """
    global _current_language
