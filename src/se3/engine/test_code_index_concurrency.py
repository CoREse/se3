...
from se3.engine import context_builder as _context_builder
...
# ---------------------------------------------------------------------------
# Fake LLMCaller stubs (monkeypatched over se3.engine.llm_caller.LLMCaller,
...
class TestConcurrentSummarizer:
    def test_reaches_exactly_max_concurrency(self, tmp_path):
        ...
        import se3.engine.llm_caller as llm_mod
...
class TestRecordIndexProgress:
    ...
    def test_missing_ids_soft_noop(self, tmp_path: Path):
        from se3.engine.chat_history import record_index_progress
