...
- `5e83839` refactor: adopt src layout for Python package structure (180 files)
- `4085328` fix: improve JSON parsing in analyze step to handle extra text from LLM (1 files)
- `f54d7be` fix: update get_project_root to find se3.yaml for project root detection (1 files)
- `539b8b5` chore: bump version to 3.3.1 (3 files)
- `8e1948f` fix: improve JSON parsing in all step handlers to handle extra text from LLM (7 files)
- `af41cb4` chore: bump version to 3.3.1 (1 files)
- `bafe8dd` docs: update VERSIONS.md for 3.3.1 with complete changes (1 files)
- `1ee2fe1` feat: add terminal output for summarize step (1 files)
- `d24e0d5` chore: bump version to 3.3.2 (3 files)
- `847cee6` feat: LLM response summary display + Ctrl+C prompt injection (2 files)
- `ebaf584` chore: bump version to 3.3.3 (4 files)
- `8f62bf2` fix: auto-insert PROPOSE before DESIGN when LLM omits it from step sequence. Fixes 'No proposal available' error. Also fix missing Path import in design.py (2 files)
...
- `fa27131` feat: improved spec matching with expanded keywords (5 files)
- `f655357` feat: LLM-driven read_spec + PROJECT_SUMMARY step + se3 summary CLI + roadmap migration to _backlog (23 files)
- `227a527` chore: update VERSIONS.md and README.md for 3.5.0 (2 files)
- `97d7710` fix: correct outdated references in _backlog files (3 files)
