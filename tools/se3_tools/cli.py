...
from .commands import lint, status, sync, verify, update, collab, commit, human_input
...
app.add_typer(human_input.app, name="human-input", help="Manage human input files")
