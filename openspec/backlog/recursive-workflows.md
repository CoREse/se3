...
**Created**: 2026-02-24
**Related**: Phase 3 Autonomous Collaboration
...
- `specs/parallel-execution/spec.md` - Parallel execution foundation
- `specs/model-dispatch/spec.md` - Model role assignment for children
